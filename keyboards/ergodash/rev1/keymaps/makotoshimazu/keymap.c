...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+---------------------------+------+------+------+------+------+------+------|
   * | Shift|   Z  |   X  |   C  |   V  |   B  |      |PageDn|      |PageUp|      |   N  |   M  |   ,  |   .  |   /  |  Up  |
   * |-------------+------+------+------+------+      +------+------+------+      +------+------+------+------+-------------|
   * | ---- |  GUI | ---- | Lower||||||||  Alt | Space|  Tab |||||||| ---- | Enter| ---- |||||||| ---- | Left | Down | Right|
   * ,----------------------------------------------------------------------------------------------------------------------.
   */
  [_QWERTY] = LAYOUT( \
    ...
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,            KC_PGDN,       KC_PGUP,          KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_UP,   \
    _______, KC_LGUI, _______, LOWER,            KC_LALT, KC_SPC, KC_TAB,        _______, KC_ENT,  _______,          _______, KC_LEFT, KC_DOWN, KC_RGHT  \
  ),
